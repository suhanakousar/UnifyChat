...
const io = new Server(server, {
  cors: {
    origin: ["http://localhost:5173", "http://localhost:3000", "https://unify-chat1-lkam.vercel.app", "https://unifychat-2.onrender.com"],
    credentials: true,
  },
});
...
io.use((socket, next) => {
  ...
  console.log("Backend Socket.IO middleware - received userId:", userId); // Add this line right after line 19
